  ...
  return (
    <div className="min-h-screen bg-surface-page flex flex-col">
      ...
      <header className="px-6 py-5 flex items-center justify-between max-w-5xl mx-auto w-full">
        <span className="text-xl font-bold text-brand-primary">Chama360</span>
      </header>
      ...
      <main className="flex-1 flex flex-col items-center justify-center px-6 py-12 text-center max-w-3xl mx-auto w-full">
        ...
        <button
          ...
          className="mt-8 bg-brand-primary hover:bg-brand-hover text-white text-base font-semibold px-8 py-4 rounded-full shadow-md transition-colors"
        >
          Start my 15-day free trial
        </button>
        <p className="mt-3 text-sm text-text-muted">No payment required to start. Cancel anytime.</p>
        ...
        <div className="mt-16 grid grid-cols-1 sm:grid-cols-2 gap-6 text-left w-full">
          {[
            ...
            <div key={f.title} className="bg-surface-card rounded-xl border border-border-default shadow-sm p-5">
        ...
        <div className="mt-16 w-full">
          <h2 className="text-xl font-bold text-text-primary mb-6">Simple, affordable pricing</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            <div className="bg-surface-card rounded-xl border border-border-default shadow-sm p-6 text-left">
              ...
              <p className="mt-3 text-sm text-text-secondary">Up to 15 members. All core features included.</p>
            </div>
        ...
        <button
          onClick={handleStartTrial}
          className="mt-12 bg-brand-primary hover:bg-brand-hover text-white text-base font-semibold px-8 py-4 rounded-full shadow-md transition-colors"
        >
          Start my 15-day free trial
        </button>
        <p className="mt-3 text-sm text-text-muted pb-12">Your first 15 days are completely free.</p>
      </main>
    </div>
  );
}
