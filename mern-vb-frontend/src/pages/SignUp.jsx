    ...
    <>
      ...
      <div className="md:hidden min-h-screen relative overflow-x-hidden font-sans">
        ...
        >
          ...
          >
            Set up your Village Bank in minutes.
          </h1>
          <p style={{ color: '#888888', fontSize: 12, lineHeight: 1.5, marginBottom: 16 }}>
            Stop managing contributions in Excel. Chama360 gives your group automatic
            calculations, instant member statements, and meeting reports in one tap.
          </p>
          <SignUp
            routing="path"
            path="/sign-up"
        ...
        >
          ...
          <div className="relative z-10 flex flex-col justify-between w-full">
            ...
            <div className="flex-1 flex flex-col justify-center max-w-md">
              ...
              >
                Trusted by Village Banks in Zambia.
              </p>
              <blockquote
                className="text-white"
                style={{
        ...
        <main className="flex-1 flex items-center justify-center bg-white px-6 py-10 lg:px-12">
          <div className="w-full max-w-md">
            ...
            <SignUp
              ...
              path="/sign-up"
              fallbackRedirectUrl="/dashboard"
              appearance={desktopClerkAppearance}
            />
          </div>
        </main>
      </div>
